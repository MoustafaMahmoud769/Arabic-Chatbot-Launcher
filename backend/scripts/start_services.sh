...
python3 -m rasa_core.run --enable_api --core /app/models/current/dialogue/ -u /app/models/current/nlu/ --endpoints /app/config/endpoints.yml --credentials /app/config/credentials.yml --debug -p $PORT
