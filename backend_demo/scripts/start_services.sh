...
java -jar FarasaSegmenterJar.jar &
...
python3 -m rasa_core.run --enable_api --core /app/models/trakhees/dialogue/ -u /app/models/trakhees/nlu/ --endpoints /app/config/endpoints.yml --credentials /app/config/credentials.yml --debug -p $PORT
